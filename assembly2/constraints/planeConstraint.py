...
FreeCADGui.addCommand('assembly2_addPlaneConstraint', PlaneConstraintCommand())
...
FreeCADGui.addCommand('assembly2_redefinePlaneConstraint', RedefineConstraintCommand())
