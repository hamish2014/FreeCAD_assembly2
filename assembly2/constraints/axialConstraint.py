...
FreeCADGui.addCommand('assembly2_addAxialConstraint', AxialConstraintCommand())
...
FreeCADGui.addCommand('assembly2_redefineAxialConstraint', RedefineConstraintCommand())
